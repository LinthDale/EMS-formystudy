...
| 起案日期 | 2026-04-24 |
| PRD 化日期 | 2026-04-29 |
| 原始規劃文件 | `doc/archive/plan/kc_integration_plan.md`（v5，2026-04-27） |
...
繼承 PRD-0001 的 NFR 表（[`doc/governance/nfr.md`](../governance/nfr.md)），補充：
...
### C. 相關文件
- `doc/archive/plan/kc_integration_plan.md`（原始規劃 v5）
- `doc/operations/容器速查表.md`（含 KC 容器）
